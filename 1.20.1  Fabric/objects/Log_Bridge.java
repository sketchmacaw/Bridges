...
public class Log_Bridge extends Bridge_Block
{
    ...
    protected static final VoxelShape SIDE_0 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 2, 14, 16, 15, 16));
    protected static final VoxelShape SIDE_90 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 2, 0, 2, 15, 16));
    protected static final VoxelShape SIDE_180 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 2, 0, 16, 15, 2));
    protected static final VoxelShape SIDE_270 = VoxelShapes.union(BASE,Block.createCuboidShape(14, 2, 0, 16, 15, 16));
    ...
    public Log_Bridge(AbstractBlock.Settings properties) {
        super(properties);
