...
public class Iron_Bridge extends Bridge_Block
{
    ...
    protected static final VoxelShape SIDE_0 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 1, 15, 16, 16, 16));
    protected static final VoxelShape SIDE_90 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 1, 0, 1, 16, 16));
    protected static final VoxelShape SIDE_180 = VoxelShapes.union(BASE,Block.createCuboidShape(0, 1, 0, 16, 16, 1));
    protected static final VoxelShape SIDE_270 = VoxelShapes.union(BASE,Block.createCuboidShape(15, 1, 0, 16, 16, 16));
    ...
    public Iron_Bridge(AbstractBlock.Settings properties) {
        super(properties);
        this.setDefaultState((BlockState)this.getDefaultState().with(CONNECTION, Bridge_Block.ConnectionStatus.BASE)
        );
    }
