...
public class Iron_Bridge extends Bridge_Block {
	...
	protected static final VoxelShape SIDE_0 = Shapes.or(BASE, Block.box(0, 1, 15, 16, 16, 16));
	protected static final VoxelShape SIDE_90 = Shapes.or(BASE, Block.box(0, 1, 0, 1, 16, 16));
	protected static final VoxelShape SIDE_180 = Shapes.or(BASE, Block.box(0, 1, 0, 16, 16, 1));
	protected static final VoxelShape SIDE_270 = Shapes.or(BASE, Block.box(15, 1, 0, 16, 16, 16));
	...
	public Iron_Bridge(Block.Properties prop) {
		super(prop);
